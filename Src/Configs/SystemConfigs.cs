...
namespace FS.Configs
{
    ...
    public class SystemConfig
    {
        ...
        public bool IsWriteDebugLog = false;

        /// <summary> 开启异常日志记录 </summary>
        public bool IsWriteErrorLog = false;

        /// <summary> 开启错误日志记录 </summary>
        public bool IsWriteFatalLog = false;

        /// <summary> 开启信息日志记录 </summary>
        public bool IsWriteInfoLog = false;

        /// <summary> 开启警告日志记录 </summary>
        public bool IsWriteWarnLog = false;
