...
namespace FS.MQ.RocketMQ.SDK
{
    public class PullConsumer : IDisposable
    {
        ...
        internal static HandleRef getCPtr(PullConsumer obj) { return obj == null ? new HandleRef(null, IntPtr.Zero) : obj.swigCPtr; }

        ~PullConsumer() { Dispose(); }
        ...
        public PullConsumer() : this(ONSClient4CPPPINVOKE.new_PullConsumer(), true) { SwigDirectorConnect(); }

        public virtual void start() { ONSClient4CPPPINVOKE.PullConsumer_start(swigCPtr); }

        public virtual void shutdown() { ONSClient4CPPPINVOKE.PullConsumer_shutdown(swigCPtr); }
        ...
        private void SwigDirectorConnect()
        {
            ...
            if (SwigDerivedClassHasMethod("fetchSubscribeMessageQueues", swigMethodTypes2)) swigDelegate2 = SwigDirectorfetchSubscribeMessageQueues;
            if (SwigDerivedClassHasMethod("pull", swigMethodTypes3)) swigDelegate3 = SwigDirectorpull;
            if (SwigDerivedClassHasMethod("searchOffset", swigMethodTypes4)) swigDelegate4 = SwigDirectorsearchOffset;
            if (SwigDerivedClassHasMethod("maxOffset", swigMethodTypes5)) swigDelegate5 = SwigDirectormaxOffset;
            if (SwigDerivedClassHasMethod("minOffset", swigMethodTypes6)) swigDelegate6 = SwigDirectorminOffset;
            if (SwigDerivedClassHasMethod("updateConsumeOffset", swigMethodTypes7)) swigDelegate7 = SwigDirectorupdateConsumeOffset;
            if (SwigDerivedClassHasMethod("removeConsumeOffset", swigMethodTypes8)) swigDelegate8 = SwigDirectorremoveConsumeOffset;
            if (SwigDerivedClassHasMethod("fetchConsumeOffset", swigMethodTypes9)) swigDelegate9 = SwigDirectorfetchConsumeOffset;
            if (SwigDerivedClassHasMethod("persistConsumerOffset4PullConsumer", swigMethodTypes10)) swigDelegate10 = SwigDirectorpersistConsumerOffset4PullConsumer;
        ...
        private void SwigDirectorfetchSubscribeMessageQueues(string topic, IntPtr mqs) { fetchSubscribeMessageQueues(topic, new SWIGTYPE_p_std__vectorT_ons__MessageQueueONS_t(mqs, false)); }
        ...
        private long SwigDirectorsearchOffset(IntPtr mq, long timestamp) { return searchOffset(new MessageQueueONS(mq, false), timestamp); }

        private long SwigDirectormaxOffset(IntPtr mq) { return maxOffset(new MessageQueueONS(mq, false)); }

        private long SwigDirectorminOffset(IntPtr mq) { return minOffset(new MessageQueueONS(mq, false)); }

        private void SwigDirectorupdateConsumeOffset(IntPtr mq, long offset) { updateConsumeOffset(new MessageQueueONS(mq, false), offset); }

        private void SwigDirectorremoveConsumeOffset(IntPtr mq) { removeConsumeOffset(new MessageQueueONS(mq, false)); }

        private long SwigDirectorfetchConsumeOffset(IntPtr mq, bool fromStore) { return fetchConsumeOffset(new MessageQueueONS(mq, false), fromStore); }

        private void SwigDirectorpersistConsumerOffset4PullConsumer(IntPtr mq) { persistConsumerOffset4PullConsumer(new MessageQueueONS(mq, false)); }
        ...
        private static readonly Type[] swigMethodTypes2 = {typeof(string), typeof(SWIGTYPE_p_std__vectorT_ons__MessageQueueONS_t)};
        private static readonly Type[] swigMethodTypes3 = {typeof(MessageQueueONS), typeof(string), typeof(long), typeof(int)};
