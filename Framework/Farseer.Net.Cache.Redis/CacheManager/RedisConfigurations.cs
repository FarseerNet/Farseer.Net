    ...
    public static class RedisConfigurations
    {
        ...
        public static void AddConfiguration(RedisConfiguration configuration)
        {
            lock (_configLock)
            {
                ...
                Guard.NotNullOrWhiteSpace(configuration.Key, nameof(configuration.Key));
        ...
        {
            Guard.NotNullOrWhiteSpace(configFileName, nameof(configFileName));
            Guard.NotNullOrWhiteSpace(sectionName, nameof(sectionName));

            Guard.Ensure(File.Exists(configFileName), "Configuration file not found [{0}].", configFileName);
            ...
            Guard.EnsureNotNull(section, "No section with name {1} found in file {0}", configFileName, sectionName);
