...
namespace Farseer.Net.Extends
{
    public static partial class Extend
    {
        ...
        public static IEnumerable<Type> GetBaseTypes(this Type type)
        {
            ...
            if (typeInfo.IsInterface) throw new ArgumentException("接口不能获取基类。");
        ...
        public static IEnumerable<Type> GetGenericTypeDefinitions(this Type type)
        {
            ...
            foreach (var genericType in type.GetTypeInfo().IsClass ? type.GetInterfacesTypes().Concat(type.GetBaseTypes()) : type.GetInterfacesTypes())
            {
