...
namespace FS.Core.Http
{
    public class HttpGet
    {
        ...
        /// <param name="encoding"> 编码格式 </param>
        /// <param name="cookie"> 是否需要cookie </param>
        [TrackHttp("GET", "url", "headerData", "postData")]
        public static async Task<HttpResponseResult> GetAsync(string url, string postData = null, IDictionary<string, string> headerData = null, int requestTimeout = 0, Encoding encoding = null, CookieContainer cookie = null)
        {
