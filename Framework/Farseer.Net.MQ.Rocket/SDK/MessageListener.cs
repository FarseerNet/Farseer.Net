...
namespace FS.MQ.RocketMQ.SDK
{
    public class MessageListener : IDisposable
    {
        ...
        internal static HandleRef getCPtr(MessageListener obj)
        {
        ...
        {
            var ret = (Action) ONSClient4CPPPINVOKE.MessageListener_consume(swigCPtr, Message.getCPtr(message),
                ConsumeContext.getCPtr(context));
