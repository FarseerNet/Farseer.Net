...
namespace FS.MQ.Rocket.SDK.Http.Runtime.Pipeline.RetryHandler
{
    ...
    public abstract class RetryPolicy
    {
        ...
        public bool Retry(IExecutionContext executionContext, Exception exception) => !RetryLimitReached(executionContext: executionContext) &&
                                                                                      CanRetry(executionContext: executionContext) &&
                                                                                      RetryForException(executionContext: executionContext, exception: exception);
