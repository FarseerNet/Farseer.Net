...
namespace FS.Data.Infrastructure
{
    ...
    internal interface IExecuteSql
    {
        ...
        T GetValue<T>(string callMethod, ISqlParam sqlParam, T defValue = default(T));
        ...
        /// <param name="sqlParam">SQL语句与参数</param>
        /// <param name="defValue">默认值</param>
        Task<T> GetValueAsync<T>(string callMethod, ISqlParam sqlParam, T defValue = default(T));
        ...
        /// <param name="entity">实体类</param>
        /// <param name="defValue">默认值</param>
        T GetValue<TEntity, T>(string callMethod, ProcBuilder procBuilder, TEntity entity, T defValue = default(T)) where TEntity : class, new();
        ...
        /// <param name="defValue">默认值</param>
        Task<T> GetValueAsync<TEntity, T>(string callMethod, ProcBuilder procBuilder, TEntity entity, T defValue = default(T)) where TEntity : class, new();
    }
}