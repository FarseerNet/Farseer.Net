...
namespace FS.Data.Internal
{
    ...
    internal class MonitorSqlExceptionLog : ISqlMonitor
    {
        ...
        public void ExecuteException(string methodName, string dbName, string tableName, CommandType cmdType, string sql, IEnumerable<DbParameter> param, long elapsedMilliseconds, Exception exp) => new SqlErrorLog(exp, dbName, tableName, CommandType.Text, sql, (List<DbParameter>)param ?? new List<DbParameter>()).Write();
