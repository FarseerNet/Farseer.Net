...
namespace FS.Data.Client.SqlServer
{
    ...
    public class SqlServerBuilder : AbsSqlBuilder
    {
        ...
        internal SqlServerBuilder(AbsDbProvider dbProvider, ExpressionBuilder expBuilder, string dbName, string tableName) : base(dbProvider: dbProvider, expBuilder: expBuilder, dbName: dbName, tableName: tableName)
        {
        }
